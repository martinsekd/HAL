...
gpio_set_value(26,1);
 ...
 static int my_char_driver_init(void){
    int err = 0;
    err = gpio_request(6,"gpio6");
    err = gpio_request(13,"gpio13");
    err = gpio_request(19,"gpio19");
    err = gpio_request(26,"gpio26");
    ...
    err = register_chrdev_region(devno,2,"LED");
